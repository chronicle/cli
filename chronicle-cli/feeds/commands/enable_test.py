...
@mock.patch(
    "feeds.commands.enable.click.prompt")
def test_enable_feed_not_exist(
...
@mock.patch(
    "feeds.commands.enable.click.prompt")
def test_enable_feed_id_invalid(
    input_patch: mock.MagicMock, mock_client: mock.MagicMock,
...
@mock.patch(
    "feeds.commands.enable.click.prompt")
def test_enable_feed_200(input_patch: mock.MagicMock,
  ...
  # Method Call
  result = runner.invoke(enable)
  expected_output = "Feed with ID: 123 enabled successfully."
...
@mock.patch(
    "feeds.commands.enable.click.prompt")
def test_enable_feed_id_absent(input_patch: mock.MagicMock,
                               mock_client: mock.MagicMock,
                               get_active_feed_data: Tuple[Dict[str, str], str],
                               get_feed_schema: Tuple[str, str]) -> None:
...
def test_enable_feed_credential_file_invalid(
  ...
  result = runner.invoke(enable, ["--credential_file", "dummy.json"])
