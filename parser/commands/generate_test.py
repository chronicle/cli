...
from parser.commands.generate import generate
from parser.tests.fixtures import *  # pylint: disable=wildcard-import
from parser.tests.fixtures import MockResponse
...
@mock.patch(
    "parser.commands.generate.click.prompt")
@mock.patch(
    "parser.constants.path_constants.PARSER_DATA_DIR",
    TEST_DATA_DIR)
def test_generate_logs(mock_input: mock.MagicMock, mock_client: mock.MagicMock,
  ...
  try:
    shutil.rmtree(TEST_DATA_DIR + "/chronicle_cli/parser/windows_dhcp")
