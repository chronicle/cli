...
from parser.commands.download import download
from parser.tests.fixtures import *  # pylint: disable=wildcard-import
from parser.tests.fixtures import TEMP_CONF_FILE
...
@mock.patch(
    ...
    TEST_DATA_DIR)
@mock.patch("parser.commands.download.time")
@mock.patch(
    "common.chronicle_auth.initialize_http_session"
)
@mock.patch("parser.url.get_url")
@mock.patch(
    "parser.commands.download.click.prompt")
